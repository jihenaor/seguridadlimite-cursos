...
import { DOCUMENT, NgStyle, NgFor, NgIf, NgClass } from '@angular/common';
import {
  Component,
  Inject,
  ElementRef,
...
@Component({
    ...
    imports: [NgStyle, NgFor, RouterLinkActive, NgIf, RouterLink, NgClass]
})
  ...
  ngOnInit() {
    if (this.authService.currentUserValue) {
      ...
      if (r === Role.Administrador || r === Role.Coordinador) {
        this.userType = Role.Administrador;
